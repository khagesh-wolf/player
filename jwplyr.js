(function () {
  ...
  */ (() => {
      var e,
        ...
        n = {
          ...
          5191: (e, t, n) => {
            ...
            const r = function (e) {
                return (
                  e.slice && "px" === e.slice(-2) && (e = e.slice(0, -2)), e
                );
              },
              i = function (e, t) {
            ...
            const u = {
              ...
              p = function (e, t) {
                ...
                t &&
                  ...
                  ("boolean" == typeof t.mute && (f.mute = t.mute),
                  delete t.mute);
                ...
                const m = g.forceLocalizationDefaults
                    ? u.language
                    : (0, c.G3)(),
                  y = (0, c.tK)(g.intl);
              ...
              _ = (e) => {
                ...
                if (n && n.code === O.u5) {
                  ...
                  if (n > 0 && n < 4 && e && r.duration() > -i) {
                    return new b.ZP(
                      `//content.jwplatform.com/libraries/${e}.js`
                    )
                      .load()
                      .then(() => {
              ...
              F = (e, t) =>
                (function (e, t) {
                  return n
                    .e(168)
                    .then(
                      ((r) => new (0, n(5545).default)(t).setup(e)).bind(
                        null,
                        n
                      )
                    )
          ...
          8348: (e, t, n) => {
            "use strict";
            n.r(t),
              n.d(t, { Browser: () => a, Features: () => c, OS: () => l });
            var r = n(2268);
            const i = (e, t) => {
                const n = e.exec(t);
            ...
            const a = Array.isArray,
              l = function (e) {
                ...
                return (
                  ...
                  a(t.tracks) || (t.tracks = []),
                  a(t.captions) &&
                    ((t.tracks = t.tracks.concat(t.captions)),
                    delete t.captions),
          ...
          8320: (e, t, n) => {
            ...
            const c = (e, t) => (void 0 === e ? t : e),
              ...
              f = (e, t, n) => {
                ...
                return (
                  delete r.playlist, e.map((e) => h(t, e, r)).filter(Boolean)
                );
              },
              g = (e) => {
                ...
                getNewInstance(e, t, n) {
                  ...
                  return (
                    (i.addToPlayer = function () {
                      const e =
                        this.getContainer().querySelector(".jw-overlays");
                      e &&
                        ((n.left = e.style.left),
                        (n.top = e.style.top),
                        e.appendChild(n));
            ...
            const s = function () {},
              ...
              c = (e, t, n) => {
                ...
                if (
                  ...
                  return (
                    e.responseXML ||
                      (e = Object.assign({}, e, { responseXML: t })),
                    n.oncomplete(e)
                  );
                l(n, o.ul, 601);
              },
            ...
            class a {
              ...
              triggerSafe(e, ...t) {
                ...
                const n = this._events[e],
                  r = this._events.all;
                return (
                  n && i(n, t, this, e), r && i(r, arguments, this, e), this
                );
              }
            }
          ...
          2268: (e, t, n) => {
            ...
            const r = (e) => null !== navigator.userAgent.match(e),
              ...
              b = () =>
                !(r(/chrome\/[123456789]/i) && !r(/chrome\/18/i) && !o()) &&
                v();
            v.mock_ = null;
          ...
          8518: (e, t, n) => {
            ...
            const l = {},
              ...
              h = (e) =>
                e
                  ? Object.keys(e).reduce((t, n) => ((t[d(n)] = e[n]), t), {})
                  : {},
              f = (e) => {
          ...
          1776: (e, t, n) => {
            ...
            n.d(t, { U: () => r, W: () => i });
            const r =
                window.requestAnimationFrame || ((e) => setTimeout(e, 17)),
          ...
          5882: (e, t, n) => {
            ...
            const b = (e, t, n) => {
              ...
              j = (e, t, n, r, i = m) => {
                let o = e.handlers[t],
                  s = e.options[t];
                if (
                  (o || ((o = e.handlers[t] = {}), (s = e.options[t] = {})),
                  o[n])
                )
              ...
              S = (e, t) => {
                ...
                j(e, t, "blur", () => {
                  ...
                  j(e, t, "focus", () => {
                    v.event &&
                      v.event.type === f &&
                      (0, a.cn)(n, "jw-tab-focus");
                  });
              },
              O = (e, t, n, r) => {
                c
                  ? j(e, t, "pointerdown", n, r)
                  : (u && j(e, t, "mousedown", n, r),
            ...
            class F extends o.ZP {
              ...
              on(e, t, n) {
                return (
                  M(e) && (this.handlers[e] || Z[e](this)), super.on(e, t, n)
                );
              }
              off(e, t, n) {
                if (M(e)) P(this, e);
          ...
          6042: (e, t, n) => {
            ...
            const A = T.Date,
              ...
              ee = function (e, t) {
                ...
                return function (...r) {
                  return (
                    --e > 0 && (n = t.apply(this, r)), e <= 1 && (t = null), n
                  );
                };
              };
          ...
          4671: (e, t, n) => {
            ...
            const f = {
              ...
              addScrollHandler(e) {
                c || ((c = !0), window.addEventListener("scroll", h)),
                  s.push(e);
              },
            ...
            const g = (e) =>
              ...
              v = (e) => {
                ...
                const n = {
                  ...
                  interactive:
                    "//ssl.p.jwpcdn.com/player/v/8.30.1/interactive.js",
                }[e];
                return n ? t + n : "";
              },
              b = (e, t, n) => {
              ...
              w = (e) => {
                ...
                return (
                  b(t, e.ga, "gapro"), b(t, e.interactive, "interactive"), t
                );
              },
              k = function (e, t) {
                let c = (0, r.ZP)(e, t);
                ...
                if (
                  ...
                  (0, o.HD)(k) &&
                    ...
                    ((c.playlist = ((e, t) => {
                      ...
                      return (
                        s &&
                          (o += `&page_description=${encodeURIComponent(s)}`),
                        t.replace(u, o)
                      );
                    })(document, c.playlist)),
                    (c.contextual = !0)),
                ...
                return (
                  c.__abSendDomainToFeeds &&
                    ((C = c.playlist),
                    /\.jwplatform.com|\.jwplayer.com/.test(C)) &&
                    (c.playlist =
                      (j = c.playlist) +
                      `${
                        -1 !== j.indexOf("?") ? "&" : "?"
          ...
          5592: (e, t, n) => {
            ...
            const i = (e) => unescape(encodeURIComponent(e)),
              ...
              a = function (e, t) {
                if (((e = String(e)), (t = String(t)), 0 === e.length))
                  return "";
                const n = o((0, r.t)(e)),
                  a = o(i(t).slice(0, 16)),
                  l = n.length,
      ...
      function i(e) {
        ...
        return (
          n[e].call(o.exports, o, o.exports, i), (o.loaded = !0), o.exports
        );
      }
      (i.m = n),
        (i.n = (e) => {
        ...
        (i.e = (e) =>
          Promise.all(
            Object.keys(i.f).reduce((t, n) => (i.f[n](e, t), t), [])
          )),
        (i.u = (e) =>
          ({
            63: "polyfills.webvtt",
  ...
  var jwDefaults = {
    ...
    displaytitle: true,
    height: 380,
    key: "w5tufhLfwCQD1S311RKcItzuvsQlJ5PT8vTtoh7yy+f5bh/x5irPJsiV0lA=",
    ph: 1,
    pid: "LYqK7LMh",
    ...
    mute: false,
    image:
      "https://blogger.googleusercontent.com/img/a/AVvXsEj3Ricx7pGJX6DIWqUbMdFWkKZGy7WYAgBv0PY4o1xh0btxbZGQPMssq-Uvq76ruIaCM3Psp4D_S5m-QOgcrqWGtWxIGnbM6mftYTmiXD9nwMJLAH5KW3Qk0slore822A7Qoaz_5U8diBOIfivyCCIDYzOVIxdYzws_51SbSXAZaKWA_fcw1MrD19R18mlv=s313",
    abouttext: "22Player.com",
    aboutlink: "https://www.22player.com/",
    logo: { file: "https://blogger.googleusercontent.com/img/a/AVvXsEj3Ricx7pGJX6DIWqUbMdFWkKZGy7WYAgBv0PY4o1xh0btxbZGQPMssq-Uvq76ruIaCM3Psp4D_S5m-QOgcrqWGtWxIGnbM6mftYTmiXD9nwMJLAH5KW3Qk0slore822A7Qoaz_5U8diBOIfivyCCIDYzOVIxdYzws_51SbSXAZaKWA_fcw1MrD19R18mlv=s313", position: "top-right", margin: "25" },
    skin: { name: "#fff", active: "#40008f" },
  };
